<x-layouts.admin>
    <x-slot:title>{{ __('Add New Car') }}</x-slot>
    ...
    <x-admin.body>
        <form action="{{ route('admin.cars.store') }}" class="col" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-selectgroup form-selectgroup-boxes d-flex flex-row">
                                    <label class="form-selectgroup-item flex-fill">
                                        <input type="radio" name="transmission_type" value="automatic"
                                            id="transmission-type" class="form-selectgroup-input" checked>
